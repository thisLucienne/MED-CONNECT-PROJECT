...
async function testPendingDoctorsAPI() {
    ...
    try {
        ...
        console.log('✅ Médecins en attente récupérés:', {
            ...
            fullResponse: pendingResponse.data
        });

        const doctors = pendingResponse.data.data || [];
        if (Array.isArray(doctors)) {
            console.log('📋 Liste des médecins:', doctors.map(d => ({
                id: d.id,
            ...
            console.log('⚠️ Format de données inattendu:', typeof doctors, doctors);
        }
