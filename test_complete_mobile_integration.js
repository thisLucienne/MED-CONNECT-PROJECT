...
async function testCompleteMobileIntegration() {
    ...
    await runTest('Services frontend mobile', async () => {
        ...
        const servicesPath = 'Frontend/med-connect/src/services';
    ...
    await runTest('Types TypeScript', async () => {
        const fs = require('fs');
        const typesPath = 'Frontend/med-connect/src/types/index.ts';
    ...
    await runTest('Configuration mobile Expo', async () => {
        const fs = require('fs');
        const packagePath = 'Frontend/med-connect/package.json';
